...
// ============================
export const OUTLINE_PROMPT = (sections: string) => `
...
// ============================
export const SLIDES_PROMPT = (outline: string, sections: string) => `
...
Rules:
- Speaker notes must be short bullet points, not paragraphs.
