  ...
  return (
    <div className="min-h-screen bg-paper-flow-canvas">
      ...
      <div className="flex min-h-[calc(100vh-80px)] flex-col items-center justify-center">
        <div className="w-full max-w-md rounded-xl border border-paper-flow-border/30 bg-white p-8 shadow-sm">
          <div className="mb-8 flex flex-col items-center">
            ...
            />
            <h2 className="text-xl font-semibold text-paper-flow-text">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-paper-flow-border/30 bg-white px-4 py-3 font-medium text-paper-flow-text transition-colors hover:bg-paper-flow-canvas"
          >
